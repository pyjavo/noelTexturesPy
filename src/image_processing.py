...
class noelTexturesPy:
    def __init__(
        self, id, t1=None, t2=None, output_dir=None, template=None, usen3=False
    ):
    ...
    def __gradient_magnitude(self):
        ...
        if self._t1file != None and self._t2file != None:
            ...
            ants.image_write(
                self._grad_t1,
                os.path.join(
                    self._outputdir, self._id + "_t1_gradient_magnitude.nii.gz"
                ),
            )
    ...
    def __relative_intensity(self):
        ...
        if self._t1file != None and self._t2file != None:
            ...
            ants.image_write(
                self._ri,
                os.path.join(
                    self._outputdir, self._id + "_t1_relative_intensity.nii.gz"
                ),
            )
    ...
    def __generate_QC_maps(self):
        ...
        if self._t1file != None and self._t2file != None:
            self._t1_n4.plot(
                ...
                nslices=32,
                title="Brain Masking",
                filename="./qc/001_brain_masking.png",
                dpi=300,
            )
            self._t1_n4.plot(
                overlay=self._segm,
                ...
                nslices=32,
                title="Segmentation",
                filename="./qc/002_segmentation.png",
                dpi=300,
            )
